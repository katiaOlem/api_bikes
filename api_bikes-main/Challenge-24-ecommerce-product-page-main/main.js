...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('../images/sudadera${event.target.id}.png')`
    });
});
...
modalthumbnails.forEach(modalthumbnail => {
    modalthumbnail.addEventListener('click', event=>{
        ...
        modalImageContainer.style.backgroundImage = `url('../images/sudadera${event.target.id.slice(-1)}.png')`
    });
});
...
function drawProductInModal(){
    productContainer.innerHTML = `
        <div class="cart-modal__details-container">
            <img class="cart-modal__image" src="./images/sudadera.png" alt="">
            <div>
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('../images/sudadera${imgIndex}.png')`
}
